...
face_detector_path = r'M:\Projects\Attendance-System-main\face-recognition-based-attendance-system-master\haarcascade_frontalface_default.xml'
...
def home():
    ...
    # Check if a slot is passed via GET (like from URL query ?slot=xyz.csv)
        ...
        if os.path.exists(slot_file):
            ...
            if username not in df['Name'].values:
                ...
                return render_template('home.html', 
                                       message=f"Attendance taken for {username} in slot {slot}.",
                                       slots=slots,
                                       slot_name=slot)
    ...
    # For GET request
    return render_template('home.html', slots=slots, slot_name=selected_slot)
